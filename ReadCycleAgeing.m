...
% IDs = {'T25_03C05D_SoC0-100','T25_03C05D_SoC10-90','T25_03C1D_SoC0-100',...
%     'T25_03C1D_SoC10-90','T25_1C1D_SoC0-100','T25_1C1D_SoC10-90',...
...
%   has a subplot per cycle regime and shows how the half-cell OCV
%   curves change due to degradation
% readAgeing_OCV
% 
% %% Read and plot the voltage during the CCCV check-up cycles
% % makes a large number of graphs, one per cycle regime
...
% %   continuous charge/discharge). If the value of 'proc.includeCycleData' 
% %   in CycleAgeing in Degradation.cpp was true, the cycling data will also
