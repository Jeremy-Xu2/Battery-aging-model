...
//	Cmaxpos = 48458;					// value for NMC
//	Cmaxneg = 30185;					// value for C
...
//	// geometry
//	L = 1.724*pow(10,-4);
//	Rp = 5.04*pow(10,-6);				// 8.5 do NOT CHANGE this value, if you do change it, you have to recalculate the spatial discretisation with the supplied Matlab scripts. See the word document '2 overview of the code', section 'Matlab setup before running the C++ code'
//	Rn = 7.97*pow(10,-6);				// 12.5 do NOT CHANGE this value, if you do change it, you have to recalculate the spatial discretisation with the supplied Matlab scripts. See the word document '2 overview of the code', section 'Matlab setup before running the C++ code'
//	SAV = 252.9915;
...
//
//	// main Li reaction
//	kp = 1.46*pow(10,-9);				// fitting parameter 0.9*pow(10,-12)
//	kp_T = 58000;
//	kn = 3.42*pow(10,-13);					// fitting parameter 4*pow(10,-10)
//	kn_T = 20000;
...
//
//	// OCV curves;
//	string nameneg = "LG_M50L_OCV_C.csv"; 						// name of the csv file with the cathode OCV curve
//	string namepos = "LG_M50L_OCV_NMC.csv";						// name of the csv file with the anode OCV curve
...
//	double Rdc = 0.010001;			// DC resistance of the total cell in Ohm 0.0102
//	fp 		= 0.2661;				// lithium fraction in the cathode at 50% soc [-]
//	fn 		= 0.9014;				// lithium fraction in the anode at 50% soc [-]
...
//	thickp	= 75.2*pow(10,-6);		// thickness of the positive electrode 70
//	thickn 	= 85.2*pow(10,-6);	// thickness of the negative electrode 1.170972150305478
...
//	Dp 		= 3.46 * pow(10,-17);			// diffusion constant of the cathode at reference temperature pow(10,-14)
//	Dn 		= 1.06 * pow(10,-15);		// diffusion constant of the anode at reference temperature 3*pow(10,-14)
...
//		seiparam.sei1k_T = 65000; //130000
//		seiparam.sei2k = 6.75*pow(10,-11);//2.75e-11
//		seiparam.sei2k_T = 45000; //130000
//		seiparam.sei2D = 8.5*pow(10,-15);//2.5e-15
//		seiparam.sei2D_T = 30000; //200000
