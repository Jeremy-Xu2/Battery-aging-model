...
void estimateOCVparameters(){
	...
	int np = 317;								// number of data points on the cathode OCV curve
	string nameneg = "OCVfit_anode.csv";		// name of the file with the OCV curve of the anode
	int nn = 428;								// number of data points on the anode OCV curve
	string namecell = "OCVfit_cell.csv";		// name of the file with the OCV curve of the cell
	int ncell = 478;								// number of data points on the cell OCV curve
	double cmaxp = 48458;						// maximum li-concentration in the cathode [mol m-3]
	double cmaxn = 30158;						// maximum li-concentration in the anode [mol m-3]
