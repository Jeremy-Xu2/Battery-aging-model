...
void CCCV_1(const struct Model& M, string pref, const struct DEG_ID& degid, int cellType, int verbose);		// function to let a cell follow a predefined current profile
